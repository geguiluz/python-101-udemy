...
# Create an administrator class that inherrits User
class Admin(User):
    """Administrator of the store"""
    
    # We are overriding the __init__ method of user
    def __init__(self, name, password, staff_id):
        """Initialize data for admin"""
        # We want to reuse the functionality of the parent class and then reuse
